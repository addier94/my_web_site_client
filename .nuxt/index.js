...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Dev.to clone with NuxtJS","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Building a dev.to clone with Nuxt.js and new fetch() hook"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"},{"rel":"stylesheet","href":"https:\u002F\u002Ffonts.googleapis.com\u002Fcss?family=Inter:400,500,600&display=swap"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_pluginmain_3d0b59f3 === 'function') {
    await nuxt_plugin_pluginmain_3d0b59f3(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_nuxtackeeclient_741f4df4 === 'function') {
    await nuxt_plugin_nuxtackeeclient_741f4df4(app.context, inject)
  }

  if (typeof nuxt_plugin_vueplaceholders_097931cc === 'function') {
    await nuxt_plugin_vueplaceholders_097931cc(app.context, inject)
  }
